        ...
        <div>
          ...
          <div className={s.aboutGrid}>
            <div className={s.aboutText}>
              <p className={s.aboutP}>My name is Harry Tiger Miller, I have independently designed, developed, and deployed 6 production business applications for clients, handling everything from architecture and payments to GDPR compliance. These applications cover systems such as e-commerce, live booking and informational sites, all of which are in the business section of this portfolio.</p> 
              <p className={s.aboutP}>I recently graduated with First Class Honours in BSc Computing from the University of Portsmouth. I&rsquo;m passionate about software engineering and its means of expressing creativity. I am eager to develop my skills, collaborate with experienced professionals, solve technical problems, and contribute to creating innovative software. My bachelor's degree is broad and covers different topics such as usability, software engineering, artificial intelligence, networks and databases. I work with Python, Java, JavaScript, TypeScript, SQL, HTML and CSS. I am currently studying MSc Applied AI at the University of Warwick.</p> 
            </div>
